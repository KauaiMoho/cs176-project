...
ax.scatter(data_framingham_cleaned['TOTCHOL'], data_framingham_cleaned['LDLC'])
ax.set_title('Total Chloestrol to LDLC (Framingham)')
ax.set_xlabel('Total Chloestrol')
ax.set_ylabel('LDLC')
...
ax.plot(data_framingham_cleaned['TOTCHOL'], y_fit)
